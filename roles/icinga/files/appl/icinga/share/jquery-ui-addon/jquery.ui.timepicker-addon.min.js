    ...
    ($.extend(Timepicker.prototype, {
      ...
      _onTimeChange: function () {
        if (this._defaults.showTimepicker) {
          ...
          (u &&
            ...
            (this.timeDefined = !0),
            u && (this._updateDateTime(), this.$input.focus()));
        }
      },
      ...
      _updateDateTime: function (e) {
        ...
        if (
          ...
          if (
            ...
            this.$input.val(r);
            var l = "",
              o = this._defaults.altSeparator
                ? this._defaults.altSeparator
                : this._defaults.separator,
              c = this._defaults.altTimeSuffix
            ...
            (this._defaults.timeOnly ||
              ((l = this._defaults.altFormat
                ...
                : this.formattedDate),
              l && (l += o)),
              (l += this._defaults.altTimeFormat
        ...
        if (i) {
          ...
          (t instanceof Date
            ...
            a &&
              s &&
              (a.support.timezone ||
                null !== a._defaults.timezone ||
                (a.timezone = -1 * s.getTimezoneOffset()),
      ...
      ($.datepicker._optionDatepicker = function (e, t, i) {
        ...
        if (n) {
          ...
          for (r in m)
            m.hasOwnProperty(r) &&
              ((u[r] = m[r]), s || (s = $.extend({}, t)), delete s[r]);
          ...
          l
            ...
            : o
              ? ((o = 0 === o ? new Date() : new Date(o)),
                ...
                (n._defaults.maxDateTime = o))
              : c && (n._defaults.onSelect = c);
        }
        return void 0 === i
